...
<h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">
  APPROVED BUDGET FOR THE CONTRACT<br>
  <u>SUPPLY ANDDELIVERY OF FERTILIZER</u><br>
  ...
  <center>
    ...
    <div class="table-wrapper">
       ...
       <tr class="table-heads">
          ...
          <th class="head-item mbr-fonts-style display-7"  rowspan="2">CURRENT MARKET PRICE</th>
          <th class="head-item mbr-fonts-style display-7" rowspan="2" >VAT,OTHER TAXES AND/OR DUTIES APPLICAPBLE</th>
          <th class="head-item mbr-fonts-style display-7"  rowspan="2">FREIGHT & INSURANCE</th>
          <th class="head-item mbr-fonts-style display-7"  rowspan="2">OTHER INDIRECT COST</th>
          <th class="head-item mbr-fonts-style display-7" rowspan="1"colspan="2">OTHER COST FACTORS, (COST
OF SUPPLY, INFLATION,
CURRENCY VALUATIOn
OTHER ADJUSTMENT)</th>
          <th class="head-item mbr-fonts-style display-7"  rowspan="2">TOTAL COST</th>
          <th class="head-item mbr-fonts-style display-7"  rowspan="2">UNIT COST</th>
        </tr>
        ...
        <tr class="table-heads">
          ...
          <td class="head-item mbr-fonts-style display-7" >1785</td>
          ...
          <td class="head-item mbr-fonts-style display-7" >Php 2,913,120.00</td>
          <td class="head-item mbr-fonts-style display-7" >Php 1,632.00</td>
        </tr>
        <tr class="table-heads">
          <td class="head-item mbr-fonts-style display-7" ></td>
          <td class="head-item mbr-fonts-style display-7" >INORGANIC FERTILIZER</td>
          <td class="head-item mbr-fonts-style display-7" ></td>
          <td class="head-item mbr-fonts-style display-7" ></td>
          <td class="head-item mbr-fonts-style display-7" ></td>
          <td class="head-item mbr-fonts-style display-7" ></td>
        ...
        <tr class="table-heads">
          <td class="head-item mbr-fonts-style display-7" ></td>
          <td class="head-item mbr-fonts-style display-7" >UREA 46-0-0 (granular)</td>
          <td class="head-item mbr-fonts-style display-7" ></td>
          <td class="head-item mbr-fonts-style display-7" ></td>
          <td class="head-item mbr-fonts-style display-7" ></td>
          <td class="head-item mbr-fonts-style display-7" ></td>
        ...
        <tr class="table-heads">
          <td class="head-item mbr-fonts-style display-7" ></td>
          <td class="head-item mbr-fonts-style display-7" >	Packaging: In bags, approx. 50kGs capacity</td>
          <td class="head-item mbr-fonts-style display-7" ></td>
          <td class="head-item mbr-fonts-style display-7" ></td>
          <td class="head-item mbr-fonts-style display-7" ></td>
          <td class="head-item mbr-fonts-style display-7" ></td>
